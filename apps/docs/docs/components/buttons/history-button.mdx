...
`HistoryButton` uses MUI's `Button` and `History` icon. Ensure your project has `@mui/material` and `@mui/icons-material` installed (see [Installation](/docs/introduction/installation)).
