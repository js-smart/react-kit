...
`LoadingSuccessButton` uses MUI's `Button` and `Save` icon. Ensure your project has `@mui/material` and `@mui/icons-material` installed (see [Installation](/docs/introduction/installation)).
