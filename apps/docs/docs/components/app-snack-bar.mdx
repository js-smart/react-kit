...
`AppSnackBar` uses MUI's `Snackbar`, `Alert`, `IconButton`, `Slide`, and the `Close` icon. Ensure your project has `@mui/material` and `@mui/icons-material` installed (see [Installation](/docs/introduction/installation)).
