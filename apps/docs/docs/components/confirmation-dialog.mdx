...
`ConfirmDialog` uses MUI's `Dialog`, `DialogTitle`, `DialogContent`, `DialogActions`, and `Button`. Ensure your project has `@mui/material` installed (see [Installation](/docs/getting-started/installation)).
